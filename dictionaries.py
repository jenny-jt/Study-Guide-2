...
def without_duplicates(words):
    ...
    """
    no_dup = set(words)
    sorted_no_dup = sorted(list(no_dup))
    return sorted_no_dup
...
def top_chars(phrase):
    ...
    """
    word = "".join(letter for letter in phrase if letter.isalnum())
    ...
    if sorted_char[1][1] == sorted_char[0][1]:
        most_common_char.append(sorted_char[0][0])
        most_common_char.append(sorted_char[1][0])
    else:
        most_common_char.append(sorted_char[0][0])
